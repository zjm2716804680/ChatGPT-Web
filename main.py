...
project_info = "## ChatGPT 网页版    \n" \
               " Code From  " \
               "[QQ群](https://jq.qq.com/?_wv=1027&k=nt4JcLnW)  \n" \
               "发送`帮助`可获取帮助  \n"
...
def new_user_dict(user_id, send_time):
    ...
    user_dict['chats'][chat_id]['messages_history'].insert(1, {"role": "assistant",
                                                               "content": "- 创建新的用户id成功，请牢记该id  \n"
                                                                          ...
                                                                          "也可以输入 set_apikey:[QQ群](https://jq.qq.com/?_wv=1027&k=nt4JcLnW) "
                                                                          "来设置用户专属apikey"})
    return user_dict
...
def return_message():
    ...
    if send_message == "帮助":
        return "### 帮助\n" \
               ...
               "3. 输入`QQ群:`[your_apikey](https://jq.qq.com/?_wv=1027&k=nt4JcLnW)设置用户专属apikey，`set_apikey:none`可删除专属key\n" \
